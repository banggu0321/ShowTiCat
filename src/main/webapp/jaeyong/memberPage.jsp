		...
		<div class="contents">
			...
			<form action="memberUpdate.do" method="get" name="myFrom">
				...
				<br> <label>이메일 : </label> <input value="${member.email}"
					type="text" disabled="disabled"><br>
				<br> <label>관심매장 : </label> <input value="${member.place_num}"
					type="text" id="place"><br>
				<br> <label>포인트 : </label> <input value="${member.point}"
					type="text" name="point" id="point" disabled="disabled"><br>
